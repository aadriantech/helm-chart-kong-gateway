...
## User Notes
I have added an environments folder that contains the customized values.yaml files, each environment file has gateway values settings from the kong chart
...
https://www.notion.so/adrian-adriano-tech/Kong-API-Gateway-283407bf73774b3b885a92d264247f3d (Private Repo)

## Sample Ingress Resource for backend services
```yaml
